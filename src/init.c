...
SEXP savvy_l2norm__impl(SEXP c_arg__x) {
    SEXP res = savvy_l2norm__ffi(c_arg__x);
    return handle_result(res);
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"savvy_l2norm__impl", (DL_FUNC) &savvy_l2norm__impl, 1},
...
void R_init_savvyMemoryLeak(DllInfo *dll) {
